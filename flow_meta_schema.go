...
type OneOfObjectHAgrRKSzSetOfAnykhpArGaqQYzyujLV struct {
...
// of the simple properties is satisfied; it lazily uses the first one that is satisfied.
// Ergo, it will not return an error if more than one property is valid.
func (o *OneOfObjectHAgrRKSzSetOfAnykhpArGaqQYzyujLV) UnmarshalJSON(bytes []byte) error {
...
func (o OneOfObjectHAgrRKSzSetOfAnykhpArGaqQYzyujLV) MarshalJSON() ([]byte, error) {
...
type FlowObject struct {
	Method *StringDoaGddGA                              `json:"method"`
	Params *OneOfObjectHAgrRKSzSetOfAnykhpArGaqQYzyujLV `json:"params"`
}
